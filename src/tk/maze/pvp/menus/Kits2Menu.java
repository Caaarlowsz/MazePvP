...
public class Kits2Menu
{
    ...
    public static void inventory(final Player p) {
        final Inventory menu = Bukkit.createInventory((InventoryHolder)p, 54, "§2§lLOJA DE KITS§a§lSEUS KITS §8(p\u00e1g. 2)");
        final ItemStack maiskits = new ItemStack(Material.getMaterial(351), 1, (short)1);
        final ItemMeta kmaiskits = maiskits.getItemMeta();
        kmaiskits.setDisplayName("§2§lLOJA DE KITS§c§lPAGINA ANTERIOR");
        ...
        kkits.setDisplayName("§2§lLOJA DE KITS§a§lSEUS KITS");
        ...
        klojadekits.setDisplayName("§2§lLOJA DE KITS§2§lLOJA DE KITS");
        ...
        kpadraokit.setDisplayName("§2§lLOJA DE KITS§3§lKIT PADRAO");
        ...
        ktodososkits.setDisplayName("§2§lLOJA DE KITS§9§lTODOS OS KITS");
        ...
        kConfigureKit.setDisplayName("§2§lLOJA DE KITS§6§lCUSTOM KIT");
        ...
        if (cfPermiss\u00e3o.getPermissao(p, "kit.strong") || cfGrupo.ChecarGrupo(p, "Pro") || cfGrupo.ChecarGrupo(p, "Youtuber") || cfGrupo.ChecarGrupo(p, "Mod") || cfGrupo.ChecarGrupo(p, "Admin") || cfGrupo.ChecarGrupo(p, "Helper") || cfGrupo.ChecarGrupo(p, "Builder") || cfGrupo.ChecarGrupo(p, "Youtuber+") || cfGrupo.ChecarGrupo(p, "Mod+") || cfGrupo.ChecarGrupo(p, "Gerente") || cfGrupo.ChecarGrupo(p, "Dono") || GiveAllCommand.fullkit || GiveAllCommand.pro) {
            menu.addItem(new ItemStack[] { criarItemMenu(Material.WATCH, "§2§lLOJA DE KITS§6§lStrong", new String[] { " §7Fi\tque Full Iron por alguns instantes!" }) });
        }
        if (cfPermiss\u00e3o.getPermissao(p, "kit.sumo") || cfGrupo.ChecarGrupo(p, "Helper") || cfGrupo.ChecarGrupo(p, "Builder") || cfGrupo.ChecarGrupo(p, "Youtuber+") || cfGrupo.ChecarGrupo(p, "Mod+") || cfGrupo.ChecarGrupo(p, "Gerente") || cfGrupo.ChecarGrupo(p, "Pro") || cfGrupo.ChecarGrupo(p, "Youtuber") || cfGrupo.ChecarGrupo(p, "Mod") || cfGrupo.ChecarGrupo(p, "Admin") || cfGrupo.ChecarGrupo(p, "Dono") || GiveAllCommand.fullkit || GiveAllCommand.pro) {
            menu.addItem(new ItemStack[] { criarItemMenu(Material.APPLE, "§2§lLOJA DE KITS§6§lSumo", new String[] { " §7Jogue seus inimigos", "§7para o alto utilizando seu peso" }) });
        }
