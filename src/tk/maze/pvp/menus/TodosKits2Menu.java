...
public class TodosKits2Menu
{
    ...
    public static void inventory(final Player p) {
        ...
        menu.setItem(27, maiskits);
        menu.addItem(new ItemStack[] { criarItemMenu(Material.WATCH, "§aStrong", new String[] { "§7Fique fulliron por 10s" }) });
        menu.addItem(new ItemStack[] { criarItemMenu(Material.APPLE, "§aSumo", new String[] { "§7Voc\u00ea \u00e9 t\u00e3o gordo que joga ", "§7seus inimigos pro alto" }) });
