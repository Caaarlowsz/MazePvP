...
public class uScore
{
    ...
    public uScore(final String title) {
        ...
        this.Times = (List<Team>)Lists.newArrayList();
    }
    ...
    private Map.Entry<Team, String> createTeam(final String message) {
        ...
        final Iterator MensagemSplit = Splitter.fixedLength(16).split((CharSequence)message).iterator();
    ...
    public void setScoreboard() {
        ...
        for (final Map.Entry Mensagem : this.Scores.entrySet()) {
            final Map.Entry Time = this.createTeam(Mensagem.getKey());
