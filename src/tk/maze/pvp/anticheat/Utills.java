...
public class Utills {
	...
	public static void sendAntiCheat(final String Menssagem) {
		...
		for (int length = (onlinePlayers = Bukkit.getOnlinePlayers()).length, i = 0; i < length; ++i) {
			...
			if (cfGrupo.ChecarGrupo(playeres, "Dono") || cfGrupo.ChecarGrupo(playeres, "Helper")
					|| cfGrupo.ChecarGrupo(playeres, "Gerente") || cfGrupo.ChecarGrupo(playeres, "Admin")
					|| cfGrupo.ChecarGrupo(playeres, "Mod+") || cfGrupo.ChecarGrupo(playeres, "Mod")
					|| cfGrupo.ChecarGrupo(playeres, "Trial") || cfGrupo.ChecarGrupo(playeres, "Youtuber+")) {
	...
	public enum Hack {
		FASTCLICKTALVEZ("FASTCLICKTALVEZ", 0,
				ChatColor.DARK_RED + "nick" + " est\u00e1 [TALVEZ] clicando r\u00e1pido demais! (CPS: clicks) ["
						+ "avisos" + "]"),
		FASTCLICKPROVAVELMENTE("FASTCLICKPROVAVELMENTE", 1,
				ChatColor.DARK_RED + "nick" + " est\u00e1 [PROVAVELMENTE] clicando r\u00e1pido demais (CPS: clicks) ["
						+ "avisos" + "]"),
		FASTCLICKDEFINITIVAMENTE("FASTCLICKDEFINITIVAMENTE", 2,
				ChatColor.DARK_RED + "nick" + " est\u00e1 [DEFINITIVAMENTE] clicando r\u00e1pido demais (CPS: clicks) ["
						+ "avisos" + "]"),
		MACROTALVEZ("MACROTALVEZ", 3,
				ChatColor.DARK_RED + "nick" + " est\u00e1 [TALVEZ] utilizando Macro/Autoclick (CPS: clicks) ["
						+ "avisos" + "]"),
		MACROPROVAVELMENTE("MACROPROVAVELMENTE", 4,
				ChatColor.DARK_RED + "nick" + " est\u00e1 [PROVAVELMENTE] utilizando Macro/Autoclick (CPS: clicks) ["
						+ "avisos" + "]"),
		MACRODEFINITIVAMENTE("MACRODEFINITIVAMENTE", 5,
				ChatColor.DARK_RED + "nick" + " est\u00e1 [DEFINITIVAMENTE] utilizando Macro/Autoclick (CPS: clicks) ["
						+ "avisos" + "]"),
		FORCEFIELDTALVEZ("FORCEFIELDTALVEZ", 6,
				ChatColor.DARK_RED + "nick" + " est\u00e1 [TALVEZ] utilizando TriggerBot [" + "avisos" + "]"),
		FORCEFIELDPROVAVELMENTE("FORCEFIELDPROVAVELMENTE", 7,
				ChatColor.DARK_RED + "nick" + " est\u00e1 [PROVAVELMENTE] utilizando TriggerBot [" + "avisos" + "]"),
		FORCEFIELDDEFINITIVAMENTE("FORCEFIELDDEFINITIVAMENTE", 8,
				ChatColor.DARK_RED + "nick" + " est\u00e1 [DEFINITIVAMENTE] utilizando TriggerBot [" + "avisos" + "]"),
		...
		AUTOSOUPTALVEZ("AUTOSOUPTALVEZ", 11,
				ChatColor.DARK_RED + "nick" + " esta [TALVEZ] utilizando AUTOSOUP [" + "avisos" + "]"),
		AUTOSOUPPROVAVELMENTE("AUTOSOUPPROVAVELMENTE", 12,
				ChatColor.DARK_RED + "nick" + " est\u00e1 [PROVAVELMENTE] utilizando AUTOSOUP [" + "avisos" + "]"),
		AUTOSOUPDEFINITIVAMENTE("AUTOSOUPDEFINITIVAMENTE", 13,
				ChatColor.DARK_RED + "nick" + " est\u00e1 [DEFINITIVAMENTE] utilizando AUTOSOUP [" + "avisos" + "]");
