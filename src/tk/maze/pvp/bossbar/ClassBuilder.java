...
public abstract class ClassBuilder {
	public static Object buildWitherSpawnPacket(final int id, final Location loc, final Object dataWatcher)
			throws Exception {
	...
	public static Object buildWitherSkullSpawnPacket(final Object skull) throws Exception {
		final Object spawnPacketSkull = NMSClass.PacketPlayOutSpawnEntity.getConstructor(NMSClass.Entity, Integer.TYPE)
	...
	public static Object buildSkullMetaPacket(final int id, final Object dataWatcher) throws Exception {
		setDataWatcherValue(dataWatcher, 0, 32);
	...
	public static Object buildNameMetadataPacket(final int id, Object dataWatcher, final int nameIndex,
			final int visibilityIndex, final String name) throws Exception {
	...
	public static Object buildWatchableObject(final int type, final int index, final Object value) throws Exception {
		return NMSClass.WatchableObject.getConstructor(Integer.TYPE, Integer.TYPE, Object.class).newInstance(type,
				index, value);
	}

	public static Object setDataWatcherValue(final Object dataWatcher, final int index, final Object value)
			throws Exception {
		final int type = getDataWatcherValueType(value);
		final Object map = AccessUtil.setAccessible(NMSClass.DataWatcher.getDeclaredField("dataValues"))
				.get(dataWatcher);
		NMUClass.gnu_trove_map_hash_TIntObjectHashMap.getDeclaredMethod("put", Integer.TYPE, Object.class).invoke(map,
	...
	public static Object getDataWatcherValue(final Object dataWatcher, final int index) throws Exception {
		final Object map = AccessUtil.setAccessible(NMSClass.DataWatcher.getDeclaredField("dataValues"))
				.get(dataWatcher);
		final Object value = NMUClass.gnu_trove_map_hash_TIntObjectHashMap.getDeclaredMethod("get", Integer.TYPE)
				.invoke(map, index);
		return value;
	}
	...
	public static Object buildArmorStandSpawnPacket(final Object armorStand) throws Exception {
		final Object spawnPacket = NMSClass.PacketPlayOutSpawnEntityLiving.getConstructor(NMSClass.EntityLiving)
	...
	public static Object buildTeleportPacket(final int id, final Location loc, final boolean onGround,
			final boolean heightCorrection) throws Exception {
