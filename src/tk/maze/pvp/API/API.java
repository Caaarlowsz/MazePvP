...
public class API
{
    ...
    public static void setarKitPadrao(final Player p) {
        ...
        if (cfConfig.pegarconfig().get("configura\u00e7\u00e3o." + p.getUniqueId() + ".PadraoKit").equals("Fisherman")) {
            cfConfig.pegarconfig().set("configura\u00e7\u00e3o." + p.getUniqueId() + ".PadraoKit", (Object)"Fisherman");
            cfConfig.salvarconfiguracao();
        }
        ...
        if (cfConfig.pegarconfig().get("configura\u00e7\u00e3o." + p.getUniqueId() + ".PadraoKit").equals("Gladiator")) {
            cfConfig.pegarconfig().set("configura\u00e7\u00e3o." + p.getUniqueId() + ".PadraoKit", (Object)"Gladiator");
            cfConfig.salvarconfiguracao();
        }
        ...
        if (cfConfig.pegarconfig().get("configura\u00e7\u00e3o." + p.getUniqueId() + ".PadraoKit").equals("FireLauncher")) {
            cfConfig.pegarconfig().set("configura\u00e7\u00e3o." + p.getUniqueId() + ".PadraoKit", (Object)"FireLauncher");
            cfConfig.salvarconfiguracao();
        }
    ...
    public static void checarAlgumasCoisas(final Player p) {
        if (!cfGrupo.ChecarGrupo(p, "Dono") && !cfGrupo.ChecarGrupo(p, "Gerente") && !cfGrupo.ChecarGrupo(p, "Admin") && !cfGrupo.ChecarGrupo(p, "Mod+") && !cfGrupo.ChecarGrupo(p, "Mod") && !cfGrupo.ChecarGrupo(p, "Youtuber+") && !cfGrupo.ChecarGrupo(p, "Pro") && !cfGrupo.ChecarGrupo(p, "Youtuber") && cfKitdiario.pegargrupo().get("kitdiario." + p.getUniqueId() + ".dia") == null) {
        ...
        if (cfTempGrupo.pegargrupo().get("tempgrupos." + p.getUniqueId() + ".Dia") != null && cfTempGrupo.pegargrupo().get("tempgrupos." + p.getUniqueId() + ".Mes") != null && cfTempGrupo.pegargrupo().get("tempgrupos." + p.getUniqueId() + ".Ano") != null && cfTempGrupo.pegargrupo().get("tempgrupos." + p.getUniqueId() + ".Hora") != null && cfTempGrupo.pegargrupo().get("tempgrupos." + p.getUniqueId() + ".Minuto") != null && cfTempGrupo.pegargrupo().get("tempgrupos." + p.getUniqueId() + ".Segundos") != null && (cfTempGrupo.pegargrupo().getInt("tempgrupos." + p.getUniqueId() + ".Dia") < CalendarioAPI.PegarCalendario(CalendarioAPI.Calendario.Dia) || (cfTempGrupo.pegargrupo().getInt("tempgrupos." + p.getUniqueId() + ".Dia") == CalendarioAPI.PegarCalendario(CalendarioAPI.Calendario.Dia) && (cfGrupo.ChecarGrupo(p, "Pro") || cfGrupo.ChecarGrupo(p, "Mvp") || cfGrupo.ChecarGrupo(p, "Light")))) && (cfTempGrupo.pegargrupo().getInt("tempgrupos." + p.getUniqueId() + ".Mes") < CalendarioAPI.PegarCalendario(CalendarioAPI.Calendario.Mes) || (cfTempGrupo.pegargrupo().getInt("tempgrupos." + p.getUniqueId() + ".Mes") == CalendarioAPI.PegarCalendario(CalendarioAPI.Calendario.Mes) && (cfGrupo.ChecarGrupo(p, "Pro") || cfGrupo.ChecarGrupo(p, "Mvp") || cfGrupo.ChecarGrupo(p, "Light")))) && (cfTempGrupo.pegargrupo().getInt("tempgrupos." + p.getUniqueId() + ".Ano") < CalendarioAPI.PegarCalendario(CalendarioAPI.Calendario.Ano) || (cfTempGrupo.pegargrupo().getInt("tempgrupos." + p.getUniqueId() + ".Ano") == CalendarioAPI.PegarCalendario(CalendarioAPI.Calendario.Ano) && (cfGrupo.ChecarGrupo(p, "Pro") || cfGrupo.ChecarGrupo(p, "Mvp") || cfGrupo.ChecarGrupo(p, "Light")))) && (cfTempGrupo.pegargrupo().getInt("tempgrupos." + p.getUniqueId() + ".Hora") < CalendarioAPI.PegarCalendario(CalendarioAPI.Calendario.Hora) || (cfTempGrupo.pegargrupo().getInt("tempgrupos." + p.getUniqueId() + ".Hora") == CalendarioAPI.PegarCalendario(CalendarioAPI.Calendario.Hora) && (cfGrupo.ChecarGrupo(p, "Pro") || cfGrupo.ChecarGrupo(p, "Mvp") || cfGrupo.ChecarGrupo(p, "Light")))) && (cfTempGrupo.pegargrupo().getInt("tempgrupos." + p.getUniqueId() + ".Minuto") < CalendarioAPI.PegarCalendario(CalendarioAPI.Calendario.Minuto) || (cfTempGrupo.pegargrupo().getInt("tempgrupos." + p.getUniqueId() + ".Minuto") == CalendarioAPI.PegarCalendario(CalendarioAPI.Calendario.Minuto) && (cfGrupo.ChecarGrupo(p, "Pro") || cfGrupo.ChecarGrupo(p, "Mvp") || cfGrupo.ChecarGrupo(p, "Light")))) && (cfTempGrupo.pegargrupo().getInt("tempgrupos." + p.getUniqueId() + ".Segundos") < CalendarioAPI.PegarCalendario(CalendarioAPI.Calendario.Segundo) || (cfTempGrupo.pegargrupo().getInt("tempgrupos." + p.getUniqueId() + ".Segundos") == CalendarioAPI.PegarCalendario(CalendarioAPI.Calendario.Segundo) && (cfGrupo.ChecarGrupo(p, "Pro") || cfGrupo.ChecarGrupo(p, "Mvp") || cfGrupo.ChecarGrupo(p, "Light"))))) {
            ...
            mandarSubTitulo(p, "§b O seu VIP " + cfGrupo.pegargrupo().getString("grupos." + p.getUniqueId() + ".grupo") + " §7acabou de expirar!");
            cfGrupo.salvarconfiguracao();
            Bukkit.getConsoleSender().sendMessage("§b§l§lLower§f§lPvP §7: §fO VIP do jogador §6§l" + p.getName() + " §facabou de expirar!");
            p.sendMessage("§b O seu VIP " + cfGrupo.pegargrupo().getString("grupos." + p.getUniqueId() + ".grupo") + " §7acabou de expirar!");
            ...
            for (int length = (onlinePlayers = Bukkit.getOnlinePlayers()).length, i = 0; i < length; ++i) {
                ...
                if (cfGrupo.ChecarGrupo(todos, "Dono") || cfGrupo.ChecarGrupo(todos, "Gerente") || cfGrupo.ChecarGrupo(todos, "Admin")) {
                    todos.sendMessage("§fO VIP " + cfGrupo.pegargrupo().getString("grupos." + p.getUniqueId() + ".grupo") + "§f do jogador §6§l" + p.getName() + " §facagou de expirar!");
                }
            }
            cfGrupo.setarGrupo(p, "Membro");
            if (cfGrupo.ChecarGrupo(p, "Dono")) {
    ...
    public static void sendItems(final Player p) {
        if (getWarp(p) == "Spawn") {
            ...
            kHeads.setLore((List)Arrays.asList("§7Selecione uma cabe\u00e7a!"));
            ...
            kVidro.setLore((List)Arrays.asList(""));
            ...
            pages.add("§7Seja muito bem-vindo ao LowerKits v2. §7Gostar\u00edamos de inform\u00e1-los que ap\u00f3s muitos dias de duro trabalho e dedica\u00e7\u00e3o de cada membro da equipe, conseguimos trazer uma otima atualiza\u00e7ao!");
    ...
    public static void mandarTitulo(final Player player, final String titulo) {
        ...
        ((CraftPlayer)player).getHandle().playerConnection.sendPacket((Packet)new ProtocolInjector.PacketTitle(ProtocolInjector.PacketTitle.Action.TITLE, ChatSerializer.a("{\"text\": \"\"}").a(titulo)));
    }
    ...
    public static void mandarSubTitulo(final Player player, final String titulo) {
        ...
        ((CraftPlayer)player).getHandle().playerConnection.sendPacket((Packet)new ProtocolInjector.PacketTitle(ProtocolInjector.PacketTitle.Action.SUBTITLE, ChatSerializer.a("{\"text\": \"\"}").a(titulo)));
    }
    ...
    public static void setHotbar(final Player p) {
        ...
        kRank.setLore((List)Arrays.asList("§7Ajuste as suas configura\u00e7\u00f5es pessoais!"));
        Rank.setItemMeta(kRank);
        final ItemStack Heads = new ItemStack(Material.NOTE_BLOCK);
        final ItemMeta kHeads = Heads.getItemMeta();
        kHeads.setDisplayName("§b§l§lHEADS");
        ...
        for (int length = (onlinePlayers = Bukkit.getOnlinePlayers()).length, i = 0; i < length; ++i) {
            ...
            if (cfGrupo.ChecarGrupo(todos, "Dono") || cfGrupo.ChecarGrupo(todos, "Gerente")) {
                ...
                for (int length2 = (onlinePlayers2 = Bukkit.getOnlinePlayers()).length, j = 0; j < length2; ++j) {
                    ...
                    if ((cfGrupo.ChecarGrupo(k, "Dono") || cfGrupo.ChecarGrupo(k, "Gerente") || cfGrupo.ChecarGrupo(k, "Admin") || cfGrupo.ChecarGrupo(k, "Mod+") || cfGrupo.ChecarGrupo(k, "Mod") || cfGrupo.ChecarGrupo(k, "Trial") || cfGrupo.ChecarGrupo(k, "Youtuber+") || cfGrupo.ChecarGrupo(k, "Helper")) && ArraysAPI.Monitor.contains(todos)) {
