...
public class PlacaLC implements Listener
{
    ...
    public void inv(final PlayerInteractEvent e) {
        ...
        if (e.getAction() == Action.RIGHT_CLICK_BLOCK && e.getClickedBlock() != null && (e.getClickedBlock().getType() == Material.WALL_SIGN || e.getClickedBlock().getType() == Material.SIGN_POST)) {
            ...
            if (lines.length > 0 && lines[0].equals("") && lines.length > 1 && lines[1].equals("§6§lCHALLENGE") && lines.length > 2 && lines[2].equals("") && lines.length > 3 && lines[3].equals("§7(F\u00e1cil)") && API.getWarp(p) == "Challenge") {
            ...
            if (lines.length > 0 && lines[0].equals("") && lines.length > 1 && lines[1].equals("§6§lCHALLENGE") && lines.length > 2 && lines[2].equals("") && lines.length > 3 && lines[3].equals("§7(M\u00e9dio)") && API.getWarp(p) == "Challenge") {
            ...
            if (lines.length > 0 && lines[0].equals("") && lines.length > 1 && lines[1].equals("§6§lCHALLENGE") && lines.length > 2 && lines[2].equals("") && lines.length > 3 && lines[3].equals("§7(Dif\u00edcil)") && API.getWarp(p) == "Challenge") {
            ...
            if (lines.length > 0 && lines[0].equals("") && lines.length > 1 && lines[1].equals("§6§lCHALLENGE") && lines.length > 2 && lines[2].equals("") && lines.length > 3 && lines[3].equals("§7(Extremo)") && API.getWarp(p) == "Challenge") {
                p.sendMessage("§b§lLAVA §7Voc\u00ea completou o §6§lLavaChallenge §fExtremo");
                Bukkit.broadcastMessage(" ");
                Bukkit.broadcastMessage("§b§lLAVA §7Parabens §c§l" + p.getName() + " §7Por Completou o n\u00edvel §e§lExtremo §fdo §6§lLavaChallenge§f!");
                Bukkit.broadcastMessage(" ");
