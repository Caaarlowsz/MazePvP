...
public class eUtills implements Listener
{
    ...
    public static long Cooldown(final Player p) {
        final long tempo = TimeUnit.MILLISECONDS.toSeconds(eUtills.CooldownChat.get(p.getName()) - System.currentTimeMillis());
        if (eUtills.CooldownChat.containsKey(p.getName()) || eUtills.CooldownChat.get(p.getName()) > System.currentTimeMillis()) {
            return tempo;
        }
        return 0L;
    }
    ...
    public void dropar(final PlayerDropItemEvent e) {
        if (e.getItemDrop().getItemStack().getType() != Material.MUSHROOM_SOUP && e.getItemDrop().getItemStack().getType() != Material.BOWL && e.getItemDrop().getItemStack().getType() != Material.ENDER_PEARL && e.getItemDrop().getItemStack().getType() != Material.RED_MUSHROOM && e.getItemDrop().getItemStack().getType() != Material.BROWN_MUSHROOM && e.getItemDrop().getItemStack().getType() != Material.GLASS_BOTTLE) {
            e.setCancelled(true);
        }
    }
    ...
    public void chat(final AsyncPlayerChatEvent e) {
        ...
        e.setFormat(String.valueOf(p.getDisplayName()) + " §7(" + sScoreAPI.getRank(p) + "§7)" + "§7» §f" + e.getMessage().replace("%", "Porcento(s)"));
    ...
    public void onCommand(final PlayerCommandPreprocessEvent e) {
        final Player p = e.getPlayer();
        if (e.getMessage().contains(":") && !cfGrupo.ChecarGrupo(p, "Dono") && !cfGrupo.ChecarGrupo(p, "Mod+") && !cfGrupo.ChecarGrupo(p, "Mod") && !cfGrupo.ChecarGrupo(p, "Gerente") && !cfGrupo.ChecarGrupo(p, "Trial") && !cfGrupo.ChecarGrupo(p, "Staff") && !cfGrupo.ChecarGrupo(p, "Youtuber+") && !cfGrupo.ChecarGrupo(p, "Admin") && !cfGrupo.ChecarGrupo(p, "Builder")) {
            e.setCancelled(true);
    ...
    public void aoChatCooldown(final AsyncPlayerChatEvent e) {
        ...
        if (ArraysAPI.CooldownChat.contains(p)) {
            if (cfGrupo.ChecarGrupo(p, "Dono") || cfGrupo.ChecarGrupo(p, "Gerente") || cfGrupo.ChecarGrupo(p, "Admin") || cfGrupo.ChecarGrupo(p, "Mod+") || cfGrupo.ChecarGrupo(p, "Mod") || cfGrupo.ChecarGrupo(p, "Trial") || cfGrupo.ChecarGrupo(p, "Youtuber+") || cfGrupo.ChecarGrupo(p, "Staff") || cfGrupo.ChecarGrupo(p, "Youtuber")) {
                return;
            }
            if (!cfGrupo.ChecarGrupo(p, "Dono") || !cfGrupo.ChecarGrupo(p, "Gerente") || !cfGrupo.ChecarGrupo(p, "Admin") || !cfGrupo.ChecarGrupo(p, "Mod+") || !cfGrupo.ChecarGrupo(p, "Mod") || !cfGrupo.ChecarGrupo(p, "Trial") || !cfGrupo.ChecarGrupo(p, "Youtuber+") || !cfGrupo.ChecarGrupo(p, "Staff") || !cfGrupo.ChecarGrupo(p, "Youtuber")) {
    ...
    public void motd(final ServerListPingEvent e) {
        e.setMotd("                     §b§lRUFFLES§f§lMC §7- §e§lPvP Server \n                  §7§nVoc\u00ea gosta de ruffles?");
    }
