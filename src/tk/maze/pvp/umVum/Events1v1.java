...
public class Events1v1 implements Listener
{
    ...
    public void Morrer2(final PlayerDeathEvent e) {
        ...
        if (e.getEntity().getKiller() instanceof Player) {
            ...
            if (m != v) {
                ...
                v.sendMessage("     ");
                v.sendMessage("§eVoc\u00ea perdeu o duelo contra §b" + m.getName() + ". §eO jogador estava com " + amountm + " sopas.");
                v.sendMessage("     ");
                WarpsAPI.Ir(m, "1v1");
    ...
    public void Morrer3(final PlayerDeathEvent e) {
        ...
        if (e.getEntity().getKiller() instanceof Player) {
            ...
            if (m != v) {
                ...
                final int amountm = this.itemsInInventory((Inventory)m.getInventory(), new Material[] { Material.MUSHROOM_SOUP });
                m.sendMessage("     ");
                m.sendMessage("§eVoc\u00ea ganhou o duelo contra §b" + v.getName() + " §e com " + amountv + " §esopas.");
                m.sendMessage("     ");
                Events1v1.inPvP.remove(m);
                Events1v1.inPvP.remove(v);
                Prote\u00e7\u00e3o.setImortal(v, true);
                Prote\u00e7\u00e3o.setImortal(m, true);
                v.sendMessage("     ");
                v.sendMessage("§eVoc\u00ea perdeu o duelo contra §b" + m.getName() + " O jogador estava com " + amountm + " §esopas.");
                v.sendMessage("     ");
                WarpsAPI.Ir(m, "1v1");
                m.setGameMode(GameMode.SURVIVAL);
                m.getInventory().setArmorContents((ItemStack[])null);
    ...
    public void cmd(final PlayerCommandPreprocessEvent event) {
        final Player p = event.getPlayer();
        if (API.getWarp(p) == "1v1" && !Events1v1.Jogando1v1Player.contains(p) && !event.getMessage().startsWith("/spawn") && !event.getMessage().startsWith("/score") && !cfGrupo.ChecarGrupo(p, "Dono") && !cfGrupo.ChecarGrupo(p, "Admin") && !cfGrupo.ChecarGrupo(p, "Gerente") && !cfGrupo.ChecarGrupo(p, "Mod+") && !cfGrupo.ChecarGrupo(p, "Mod") && !cfGrupo.ChecarGrupo(p, "Trial") && !cfGrupo.ChecarGrupo(p, "Youtuber+") && !cfGrupo.ChecarGrupo(p, "Helper")) {
    ...
    public void cmda(final PlayerCommandPreprocessEvent event) {
        final Player p = event.getPlayer();
        if (Events1v1.Jogando1v1Player.contains(p) && API.getWarp(p) == "1v1" && !event.getMessage().startsWith("/score") && !cfGrupo.ChecarGrupo(p, "Dono") && !cfGrupo.ChecarGrupo(p, "Admin") && !cfGrupo.ChecarGrupo(p, "Gerente") && !cfGrupo.ChecarGrupo(p, "Mod+") && !cfGrupo.ChecarGrupo(p, "Mod") && !cfGrupo.ChecarGrupo(p, "Trial")) {
