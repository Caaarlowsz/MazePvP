				...
				if (sender instanceof Player) {
					if (k == null) {
						...
						if (arg.equalsIgnoreCase("light")) {
							p.sendMessage("§b§lGIVEVIP: §7Voc\u00ea aplicou o vip §a§lVIP §7para o jogador: §a§l"
									+ off.getName());
						...
						if (arg.equalsIgnoreCase("premium")) {
							p.sendMessage("§b§lGIVEVIP: §7Voc\u00ea aplicou o vip §9§lMVP §7para o jogador: §9§l"
									+ off.getName());
						...
						if (arg.equalsIgnoreCase("ultimate")) {
							p.sendMessage("§b§lGIVEVIP: §7Voc\u00ea aplicou o vip §6§lPRO §7para o jogador: §6§l"
									+ off.getName());
					...
					if (k != null) {
						if (arg.equalsIgnoreCase("light")) {
							p.sendMessage("§b§lGIVEVIP: §7Voc\u00ea aplicou o vip §a§lLIGHT §7para o jogador: §a§l"
									+ k.getName());
						...
						if (arg.equalsIgnoreCase("mvp")) {
							p.sendMessage("§b§lGIVEVIP: §7Voc\u00ea aplicou o vip §9§lPREMIUM §fpara o jogador: §9§l"
									+ k.getName());
						...
						if (arg.equalsIgnoreCase("pro")) {
							p.sendMessage("§b§lGIVEVIP: §7Voc\u00ea aplicou o vip §6§lPRO §fpara o jogador: §6§l"
									+ k.getName());
							k.sendMessage(
									"§b§lGIVEVIP: §7Voc\u00ea recebeu o Vip Pro. Seu grupo foi alterado para Pro.");
