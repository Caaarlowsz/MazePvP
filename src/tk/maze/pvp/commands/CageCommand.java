...
public class CageCommand implements CommandExecutor
{
    public boolean onCommand(final CommandSender sender, final Command cmd, final String label, final String[] args) {
        ...
        if (cmd.getName().equalsIgnoreCase("cage")) {
            ...
            if (args.length == 0) {
                p.sendMessage("§7Use: §6§l/cage <nickname> §7para prender um jogador. Lembre-se: \u00c9 necess\u00e1rio que voc\u00ea seja no m\u00ednimo §3§lYOUTUBER+ §7ou §5§lMOD+ §7para executar este comando por espont\u00e2nea vontade ou poder\u00e1 sofrer consequ\u00eancias graves!");
                return true;
            }
            if (args.length == 1) {
