        ...
        if (Cmd.getName().equalsIgnoreCase("report")) {
            if (Args.length >= 2) {
                ...
                if (target != null) {
                    ...
                    p.sendMessage("§aO seu reporte foi enviado com sucesso! Assim que poss\u00edvel, um membro da equipe ir\u00e1 verifica-lo.");
                    ...
                    for (int length = (onlinePlayers = Bukkit.getOnlinePlayers()).length, i = 0; i < length; ++i) {
                        ...
                        if (cfGrupo.ChecarGrupo(s, "Dono") || cfGrupo.ChecarGrupo(s, "Gerente") || cfGrupo.ChecarGrupo(s, "Admin") || cfGrupo.ChecarGrupo(s, "Mod+") || cfGrupo.ChecarGrupo(s, "Mod") || cfGrupo.ChecarGrupo(s, "Trial") || cfGrupo.ChecarGrupo(s, "Youtuber+")) {
                            ...
                            ChatInterativo.Comando(s.getName(), "§7Clique §b§l§nAQUI §fpara teleportar at\u00e9 o jogador.", "/tp " + target.getName(), "§eClique! §8(bot\u00e3o esquerdo)");
                    ...
                    p.sendMessage("§b§lREPORT: §7O jogador em quest\u00e3o est\u00e1 offline ou nunca entrou no servidor!");
                }
            }
            else {
