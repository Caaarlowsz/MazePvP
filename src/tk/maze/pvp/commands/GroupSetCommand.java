	...
	public boolean onCommand(final CommandSender Sender, final Command Cmd, final String Label, final String[] Args) {
		if (Cmd.getName().equalsIgnoreCase("groupset") && Sender instanceof Player) {
			...
			if (target == null) {
				...
				if (Args[1].equalsIgnoreCase("ultima")) {
					p.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + targetoff.getName() + " §7para: §d§lULTIMATE");
				...
				if (Args[1].equalsIgnoreCase("youtuber")) {
					p.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + targetoff.getName() + " §7para: §b§lYOUTUBER");
				...
				if (Args[1].equalsIgnoreCase("youtuber+")) {
					p.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + targetoff.getName() + " §7para: §3§lYOUTUBER+");
					cfGrupo.setarGrupo(targetoff, "Youtuber+");
					cfGrupo.salvarconfiguracao();
					return true;
				}
				if (Args[1].equalsIgnoreCase("ajudante")) {
					p.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + targetoff.getName() + " §7para: §9§lAJUDANTE");
				...
				if (Args[1].equalsIgnoreCase("builder+")) {
					p.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + targetoff.getName() + " §7para: §2§lBUILDER+");
					cfGrupo.setarGrupo(targetoff, "Builder+");
					cfGrupo.salvarconfiguracao();
					return true;
				}
				if (Args[1].equalsIgnoreCase("gc")) {
					p.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + targetoff.getName() + " §7para: §1§lGCDETECTOR");
			...
			if (Args[1].equalsIgnoreCase("membro")) {
				...
				cfConfig.pegarconfig().set("configura\u00e7\u00e3o." + target.getUniqueId() + ".Silent",
						(Object) "OFF");
				cfConfig.salvarconfiguracao();
		...
		if (!(Sender instanceof Player)) {
			...
			if (target2 == null) {
				...
				if (Args[1].equalsIgnoreCase("membro")) {
					Sender.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + targetoff2.getName() + " §7para: §7§lMEMBRO");
					cfConfig.pegarconfig().set("configura\u00e7\u00e3o." + targetoff2.getUniqueId() + ".Silent",
							(Object) "OFF");
					cfConfig.salvarconfiguracao();
				...
				if (Args[1].equalsIgnoreCase("light")) {
					Sender.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + targetoff2.getName() + " §7para: §a§lLIGHT");
				...
				if (Args[1].equalsIgnoreCase("premium")) {
					Sender.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + targetoff2.getName() + " §7para: §1§lBETA");
				...
				if (Args[1].equalsIgnoreCase("semiyt")) {
					Sender.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + targetoff2.getName() + " §7para: §e§lSEMIYT");
				...
				if (Args[1].equalsIgnoreCase("ultimate")) {
					Sender.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + targetoff2.getName() + " §7para: §d§lULTIMATE");
				...
				if (Args[1].equalsIgnoreCase("youtuber")) {
					Sender.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + targetoff2.getName() + " §7para: §b§lYOUTUBER");
				...
				if (Args[1].equalsIgnoreCase("youtuber+")) {
					Sender.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + targetoff2.getName() + " §7para: §3§lYOUTUBER+");
					cfGrupo.setarGrupo(targetoff2, "Youtuber+");
					cfGrupo.salvarconfiguracao();
					return true;
				}
				if (Args[1].equalsIgnoreCase("builder")) {
					Sender.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + targetoff2.getName() + " §7para: §2§lBUILDER");
				...
				if (Args[1].equalsIgnoreCase("ajudante")) {
					Sender.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + targetoff2.getName() + " §7para: §9§lAJUDANTE");
				...
				if (Args[1].equalsIgnoreCase("gc")) {
					Sender.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + targetoff2.getName() + " §7para: §1§lGCDETECTOR");
				...
				if (Args[1].equalsIgnoreCase("trial")) {
					Sender.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + targetoff2.getName() + " §7para: §5§lTRIAL");
				...
				if (Args[1].equalsIgnoreCase("mod")) {
					Sender.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + targetoff2.getName() + " §7para: §5§lMOD");
				...
				if (Args[1].equalsIgnoreCase("admin")) {
					Sender.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + targetoff2.getName() + " §7para: §c§lADMIN");
				...
				if (Args[1].equalsIgnoreCase("gerente")) {
					Sender.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + targetoff2.getName() + " §7para: §c§lGERENTE");
				...
				if (Args[1].equalsIgnoreCase("dono")) {
					Sender.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + targetoff2.getName() + " §7para: §4§lDONO");
			...
			if (target2 != null) {
				...
				if (Args[1].equalsIgnoreCase("membro")) {
					Sender.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + target2.getName() + " §7para: §7§lMEMBRO");
					target2.sendMessage("§eO seu grupo foi alterado para Membro!");
					cfConfig.pegarconfig().set("configura\u00e7\u00e3o." + target2.getUniqueId() + ".Silent",
							(Object) "OFF");
					cfConfig.salvarconfiguracao();
				...
				if (Args[1].equalsIgnoreCase("light")) {
					Sender.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + target2.getName() + " §7para: §a§lLIGTH");
				...
				if (Args[1].equalsIgnoreCase("semiyt")) {
					Sender.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + target2.getName() + " §7para: §e§lSEMIYT");
				...
				if (Args[1].equalsIgnoreCase("ultimate")) {
					Sender.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + target2.getName() + " §7para: §d§lULTIMATE");
				...
				if (Args[1].equalsIgnoreCase("youtuber")) {
					Sender.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + target2.getName() + " §7para: §b§lYOUTUBER");
				...
				if (Args[1].equalsIgnoreCase("youtuber+")) {
					Sender.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + target2.getName() + " §7para: §3§lYOUTUBER+");
				...
				if (Args[1].equalsIgnoreCase("builder")) {
					Sender.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + target2.getName() + " §7para: §2§lBUILDER");
				...
				if (Args[1].equalsIgnoreCase("ajudante")) {
					Sender.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + target2.getName() + " §7para: §6§lAJUDANTE");
				...
				if (Args[1].equalsIgnoreCase("gc")) {
					Sender.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + target2.getName() + " §7para: §1§lGCDETECTOR");
				...
				if (Args[1].equalsIgnoreCase("trial")) {
					Sender.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + target2.getName() + " §7para: §5§lTRIAL");
					target2.sendMessage("§eO seu grupo foi alterado para Trial!");
					TituloAPI.MandarTitulo(target2, "§a§lGRUPO");
				...
				if (Args[1].equalsIgnoreCase("admin")) {
					Sender.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + target2.getName() + " §7para: §c§lADMIN");
				...
				if (Args[1].equalsIgnoreCase("gerente")) {
					Sender.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + target2.getName() + " §7para: §c§lGERENTE");
