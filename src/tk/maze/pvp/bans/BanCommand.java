...
public class BanCommand implements CommandExecutor
{
    public boolean onCommand(final CommandSender sender, final Command cmd, final String label, final String[] args) {
        ...
        if (!cfGrupo.ChecarGrupo(jogador, "Dono") && !cfGrupo.ChecarGrupo(jogador, "Gerente") && !cfGrupo.ChecarGrupo(jogador, "Gcwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww") && !cfGrupo.ChecarGrupo(jogador, "Admin") && !cfGrupo.ChecarGrupo(jogador, "Mod+") && !cfGrupo.ChecarGrupo(jogador, "Mod") && !cfGrupo.ChecarGrupo(jogador, "Trial") && !cfGrupo.ChecarGrupo(jogador, "Youtuber+")) {
        ...
        if (vitima == null) {
            ...
            if (Config.getConfig().getBans().get("Bans." + vitimaoff.getUniqueId()) != null) {
                API.sendMsg((CommandSender)jogador, "§7O jogador §c§l" + vitimaoff.getName() + " §fj\u00e1 est\u00e1 §4§lBANIDO");
                API.sendSound(jogador, Sound.NOTE_PLING, 10);
                return true;
            }
            if (Config.getConfig().getIpBans().get("IPBans." + vitimaoff.getUniqueId()) != null) {
                API.sendMsg((CommandSender)jogador, "§7O jogador §c§l" + vitimaoff.getName() + " §fj\u00e1 est\u00e1 §4§lBANIDO§e(IP)");
                API.sendSound(jogador, Sound.NOTE_PLING, 10);
                return true;
            }
            if (Config.getConfig().getTempBans().get("TempBans." + vitimaoff.getUniqueId()) != null) {
                API.sendMsg((CommandSender)jogador, "§7O jogador §c§l" + vitimaoff.getName() + " §7j\u00e1 est\u00e1 §9§lBANIDO§e(tempban).");
                API.sendSound(jogador, Sound.NOTE_PLING, 10);
                return true;
            }
            ...
            API.sendBC("§7O Staff §e" + jogador.getName() + " §7baniu §4§lPERMANENTEMENTE §7O Player: §c" + vitimaoff.getName() + "§7. Motivo: §e" + Motivo);
            API.sendMsg((CommandSender)jogador, "§7Voc\u00ea baniu o jogador §c§l" + vitimaoff.getName() + "§f.");
            API.sendStaff("§7O Staffer §e§l" + jogador.getName() + " §7baniu o jogador §c§l" + vitimaoff.getName() + "§f. Motivo: §c§l" + Motivo);
            ...
            Config.getConfig().getBans().set("Bans." + vitimaoff.getUniqueId() + ".Data do banimento", (Object)HorarioAPI.getHorario());
            ...
            if (Config.getConfig().getBans().get("Bans." + vitima.getUniqueId()) != null) {
                API.sendMsg((CommandSender)jogador, "§7O jogador §c§l" + vitima.getName() + " §7j\u00e1 est\u00e1 §4§lBANIDO");
                API.sendSound(jogador, Sound.NOTE_PLING, 10);
                return true;
            }
            if (Config.getConfig().getIpBans().get("IPBans." + vitima.getUniqueId()) != null) {
                API.sendMsg((CommandSender)jogador, "§7O jogador §c§l" + vitima.getName() + " §7j\u00e1 est\u00e1 §4§lBANIDO§4(IP)");
                API.sendSound(jogador, Sound.NOTE_PLING, 10);
                return true;
            }
            if (Config.getConfig().getTempBans().get("TempBans." + vitima.getUniqueId()) != null) {
                API.sendMsg((CommandSender)jogador, "§7O jogador §c§l" + vitima.getName() + " §7j\u00e1 est\u00e1 §4§lBANIDO§9(tempban)");
                API.sendSound(jogador, Sound.NOTE_PLING, 10);
                return true;
            }
            if (args.length == 1) {
            ...
            API.sendStaff("§7O Staffer: §e§l" + jogador.getName() + "§7baniu o jogador §c§l" + vitima.getName() + "§f. Motivo: §c§l" + Motivo2);
            vitima.kickPlayer("§7Voce foi banido do §b§lMAZE §7!\n§7Voc\u00ea foi banido §4§lPERMANENTEMENTE §7do servidor!\n§7Banido: §c§l" + vitima.getName() + "\n" + "§c§l" + jogador.getName() + "\n" + "§7Motivo: §c§l" + Motivo2 + "\n" + "§7Expira em: §c§lNUNCA" + "\n" + "§7Data do banimento: §c" + HorarioAPI.getHorario() + "\n" + "§7Compre UNBAN em nossa loja: §eBREVE!");
            vitima.kickPlayer("§7Voce foi banido do §b§lMAZE §7!\n§7Por" + jogador.getName() + "§7No dia " + HorarioAPI.getHorario() + "§7");
