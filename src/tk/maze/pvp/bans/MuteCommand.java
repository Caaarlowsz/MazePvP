...
public class MuteCommand implements CommandExecutor {
	public boolean onCommand(final CommandSender sender, final Command cmd, final String label, final String[] args) {
		...
		if (!cfGrupo.ChecarGrupo(jogador, "Dono") && !cfGrupo.ChecarGrupo(jogador, "Gc")
		...
		API.sendStaff("�9�lMUTE �f" + jogador.getName() + " mutou o jogador �c�l" + vitima.getName()
				+ "�f. Motivo: �6�l" + Motivo);
		API.sendMsg((CommandSender) vitima,
				"�7Voc\u00ea foi Mutado por: �b�l" + jogador.getName() + "�7. Motivo: �c�l" + Motivo);
