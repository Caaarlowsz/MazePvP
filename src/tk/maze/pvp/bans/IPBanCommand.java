...
public class IPBanCommand implements CommandExecutor {
	public boolean onCommand(final CommandSender sender, final Command cmd, final String label, final String[] args) {
		...
		if (Config.getConfig().getBans().get("Bans." + vitima.getUniqueId()) != null) {
			API.sendMsg((CommandSender) jogador,
					"�fO Jogador �6�l" + vitima.getName() + " �7j\u00e1 est\u00e1 �4�lBANIDO�f! ");
			API.sendSound(jogador, Sound.NOTE_PLING, 10);
			return true;
		}
		if (Config.getConfig().getIpBans().get("IPBans." + vitima.getUniqueId()) != null) {
			API.sendMsg((CommandSender) jogador,
					"�fO Jogador �6�l" + vitima.getName() + " �7j\u00e1 est\u00e1 �6�lBANIDO�4(IP)�f!");
			API.sendSound(jogador, Sound.NOTE_PLING, 10);
			return true;
		}
		...
		API.sendStaff("�f" + jogador.getName() + " baniu o IP do jogador �c�l" + vitima.getName() + "�7. Motivo: �6�l"
				+ Motivo);
		vitima.kickPlayer(
				"�7Voc\u00ea teve o seu IP �4�lBANIDO PERMANENTEMENTE �7 do servidor!\n�7Username banido: �c�l"
